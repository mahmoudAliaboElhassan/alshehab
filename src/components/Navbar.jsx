...
export default function Navbar() {
  return (
    <motion.nav
      ...
      className="bg-darkBrown sticky top-0 z-50 px-4 md:px-10 py-3 flex items-center justify-between"
    >
      {/* اللوجو */}
      <span className="text-cream font-black text-base md:text-lg tracking-wide whitespace-nowrap">
        الشهاب للمكيفات
      </span>
